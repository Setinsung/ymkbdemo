...
public class UpdateKbAppCommandValidator : AbstractValidator<UpdateKbAppCommand>
{
    public UpdateKbAppCommandValidator()
    {
        RuleFor(command => command.Id).NotEmpty().WithMessage("KbApp Id is required.");
