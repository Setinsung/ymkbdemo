...
namespace YMKB.UI.APIs.WeatherForecast
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::YMKB.UI.APIs.WeatherForecast.WeatherForecastRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        public async Task<List<global::YMKB.UI.APIs.Models.WeatherForecast>> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::YMKB.UI.APIs.Models.WeatherForecast>(requestInfo, global::YMKB.UI.APIs.Models.WeatherForecast.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::YMKB.UI.APIs.WeatherForecast.WeatherForecastRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::YMKB.UI.APIs.WeatherForecast.WeatherForecastRequestBuilder WithUrl(string rawUrl)
        {
