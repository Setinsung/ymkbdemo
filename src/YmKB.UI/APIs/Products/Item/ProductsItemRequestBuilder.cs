...
namespace YMKB.UI.APIs.Products.Item
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::YMKB.UI.APIs.Products.Item.ProductsItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::YMKB.UI.APIs.Models.ProductDto?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::YMKB.UI.APIs.Models.ProductDto> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::YMKB.UI.APIs.Products.Item.ProductsItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::YMKB.UI.APIs.Products.Item.ProductsItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
