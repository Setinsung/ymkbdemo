...
#nullable enable
        public List<global::YMKB.UI.APIs.Models.ProductDto>? Items { get; set; }
#nullable restore
#else
        public List<global::YMKB.UI.APIs.Models.ProductDto> Items { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::YMKB.UI.APIs.Models.PaginatedResultOfProductDto"/> and sets the default values.
        /// </summary>
        ...
        public static global::YMKB.UI.APIs.Models.PaginatedResultOfProductDto CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::YMKB.UI.APIs.Models.PaginatedResultOfProductDto();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "items", n => { Items = n.GetCollectionOfObjectValues<global::YMKB.UI.APIs.Models.ProductDto>(global::YMKB.UI.APIs.Models.ProductDto.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::YMKB.UI.APIs.Models.ProductDto>("items", Items);
